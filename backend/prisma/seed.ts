...
async function main() {
    ...
    const patients = await Promise.all([
        ...
        prisma.patient.create({ data: { firstName: 'Alice', lastName: 'Uwimana', dateOfBirth: new Date('1997-06-10'), sex: Sex.FEMALE, phone: '+250722987654', email: 'alice.uwimana@mail.com', country: 'Rwanda', city: 'Gisenyi' } }),
        ...
        prisma.patient.create({ data: { firstName: 'David', lastName: 'Mugisha', dateOfBirth: new Date('1988-09-30'), sex: Sex.MALE, phone: '+250733111222', email: 'david.mugisha@mail.com', country: 'Uganda', city: 'Kampala' } }),
        ...
        prisma.patient.create({ data: { firstName: 'Patrick', lastName: 'Habimana', dateOfBirth: new Date('1976-07-14'), sex: Sex.MALE, phone: '+250722333444', email: 'patrick.habimana@mail.com', country: 'Rwanda', city: 'Musanze' } }),
        ...
        prisma.patient.create({ data: { firstName: 'Jean', lastName: 'Ndayisaba', middleName: 'Claude', dateOfBirth: new Date('1960-05-20'), sex: Sex.MALE, phone: '+250788666777', email: 'jean.ndayisaba@mail.com', country: 'Rwanda', city: 'Kigali' } }),
        ...
        prisma.patient.create({ data: { firstName: 'Samuel', lastName: 'Bizimana', dateOfBirth: new Date('1982-10-08'), sex: Sex.MALE, phone: '+250788777888', email: 'samuel.bizimana@mail.com', country: 'Burundi', city: 'Gitega' } }),
        ...
        prisma.patient.create({ data: { firstName: 'Robert', lastName: 'Kamanzi', dateOfBirth: new Date('1975-03-28'), sex: Sex.MALE, phone: '+250788111333', email: 'robert.kamanzi@mail.com', country: 'Rwanda', city: 'Nyagatare' } }),
        ...
        prisma.patient.create({ data: { firstName: 'Eric', lastName: 'Tuyishime', middleName: 'James', dateOfBirth: new Date('1993-06-22'), sex: Sex.MALE, phone: '+250788333444', email: 'eric.tuyishime@mail.com', country: 'Rwanda', city: 'Kigali' } }),
        ...
        prisma.patient.create({ data: { firstName: 'François', lastName: 'Bizimungu', dateOfBirth: new Date('1968-09-15'), sex: Sex.MALE, phone: '+250788555666', email: 'francois.bizimungu@mail.com', country: 'Rwanda', city: 'Muhanga' } }),
    ]);
